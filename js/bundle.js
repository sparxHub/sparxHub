...
//         <h1>Comments</h1>
//         <CommentList data={this.props.data ? this.props.data  : this.state.data} />
//         <CommentForm />
//       </div>
//     );
//   }
...
//
// var data = [
//   {author: "Pete Hunt", text: "New comment 1"},
//   {author: "Jordan Walke", text: "New comment *2*"}
// ];
//
// React.render(
...
// );
//
// var Wrapper = function(initialData, el) {
// 	try
// 	{
// 	  var pages = initialData;
// 	  var render = function() {
// 	    return React.render(<CommentBox data={pages} />, el)
// 	  };
// 	  // remove = function() { ids.pop(); render(); }
// 	  // add = function() { ids.push(Math.random()); render(); } 
// 	  // render();
//
// 	  return {
// 		render: render
...
var PickUpTitle = _react2["default"].createClass({
	displayName: "PickUpTitle",

	render: function render() {
		return _react2["default"].createElement(
			"h2",
			{ className: "pick-title" },
			"Pick your business page"
		);
	}
});

var PickupListItem = _react2["default"].createClass({
	displayName: "PickupListItem",

	render: function render() {
		return _react2["default"].createElement(
			"a",
			{ className: "w-clearfix w-inline-block header-pick", href: 'result.html?id=' + this.props.id + '&at=' + this.props.access_token },
			_react2["default"].createElement("img", { className: "fb-logo", src: this.props.picture_url }),
			_react2["default"].createElement(
				"h2",
				{ className: "fb-page-name mobile" },
				this.props.name
			)
		);
	}
...
var PickUpList = _react2["default"].createClass({
	displayName: "PickUpList",

	render: function render() {
		var pageNodes = this.props.data.map(function (page) {
			return _react2["default"].createElement(PickupListItem, { id: page.id, access_token: page.access_token, picture_url: page.picture.data.url, name: page.name });
		});
...
var PickUpComponent = _react2["default"].createClass({
	displayName: "PickUpComponent",
...
var ReactBridge = function ReactBridge(initialData, el) {
	try {
		var pages = initialData;
		var render = function render() {
			return _react2["default"].render(_react2["default"].createElement(PickUpComponent, { data: pages }), el);
		};
		// remove = function() { ids.pop(); render(); }
		// add = function() { ids.push(Math.random()); render(); } 
